...
export function NewsPage({ endpoint, apiKey, videoPath, onAddSystemLog }: { endpoint?: string; apiKey?: string; videoPath: string; onAddSystemLog: (text: string, level: "INFO" | "WARNING" | "SUCCESS" | "ERROR") => void }) {
  ...
  return <div className="relative h-full overflow-y-auto bg-slate-50 dark:bg-[#212429]">
    <PageLoader active={loading} label="加载影视资讯" />
    <div className="sticky top-0 z-10 flex items-center justify-between border-b border-slate-200/80 bg-white/90 px-6 py-4 backdrop-blur dark:border-[#3d424b] dark:bg-[#212429]/90">
